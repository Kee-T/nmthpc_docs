...
| [VASP] (L) (https://vasp.at) | 6.4.3 (D) | VASP (Vienna Ab initio Simulation Package) is a first-principles simulation package for performing electronic structure calculations and atomistic materials modeling using density functional theory (DFT), molecular dynamics, and related methods. |
